         ...
         inContext:(CGContextRef)context
{
	...
	if (!self.theme.sliceDividerHidden && self.theme.sliceDividerThickness > 0) {
		...
		// Draw just two arcs, one for the completed slices and one for the uncompleted ones.
		...
		// Draw the arcs grouped instead of individually to avoid artifacts between one slice and another.
